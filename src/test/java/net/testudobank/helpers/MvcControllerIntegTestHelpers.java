...
public class MvcControllerIntegTestHelpers {
  ...
  public static void addCustomerToDB(DatabaseDelegate dbDelegate, String ID, String password, String firstName, String lastName, int checkingBalance, int savingsBalance, int checkingOverdraftBalance, int savingsOverdraftBalance, int numFraudReversals, int numInterestDeposits) throws ScriptException {
    String insertCustomerSql = String.format("INSERT INTO Customers VALUES ('%s', '%s', '%s', %d, %d, %d, %d, %d, %d)", ID, firstName, lastName, checkingBalance, savingsBalance, checkingOverdraftBalance, savingsOverdraftBalance, numFraudReversals, numInterestDeposits);
  ...
  public static void addCustomerToDB(DatabaseDelegate dbDelegate, String ID, String password, String firstName, String lastName, int checkingBalance, int savingsBalance, int interestDeposits) throws ScriptException {
    addCustomerToDB(dbDelegate, ID, password, firstName, lastName, checkingBalance, savingsBalance, 0, 0, 0, 0);
  }
